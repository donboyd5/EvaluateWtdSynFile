...
outfn <- paste0(outdir, "eval_", format(Sys.time(), "%Y-%m-%d-%H-%M"), ".html")
rmarkdown::render(rmdfn, output_format="html_document", output_file=outfn)


# CAUTION: 
# pandoc, which renders the html output, is a memory hog
# the default Windows installation appears to be a 32-bit version that only allows 2 gb of memory to be addressed
# apparently that is not enough for the large html files this produces on the order of 10-20 mb
# There appear to be two solutions:
#   1. Partial solution: use Large Address Aware to modify the pandoc binary to allow it to
#      address the full 4 gb that 32 bit Windows allows
#        https://github.com/yihui/knitr/issues/1152
#        https://github.com/rstudio/rmarkdown/issues/927
#        https://www.techpowerup.com/forums/threads/large-address-aware.112556/
#        https://black-tea.github.io/setup-notes/2017/11/11/Knitr-Pandoc-Out-of-Memory.html
#   2. Potentially full solution: download and install a 64-bit binary - this is new and maybe not the default
#        https://github.com/jgm/pandoc/issues/3669
